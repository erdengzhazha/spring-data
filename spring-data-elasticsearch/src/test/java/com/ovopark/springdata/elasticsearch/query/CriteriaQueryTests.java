...
import com.ovopark.springdata.elasticsearch.SpringdataApplication;
import com.ovopark.springdata.elasticsearch.entity.SampleEntity;
...
import com.ovopark.springdata.elasticsearch.util.*;
...
public class CriteriaQueryTests {
	...
	public void shouldReturnDocumentAboveMinimalScoreGivenCriteria() {
		...
		indexQueries.add(IndexBuilder.buildIndex(SampleEntity.builder().id("1").message("ab").build()));
		indexQueries.add(IndexBuilder.buildIndex(SampleEntity.builder().id("2").message("bc").build()));
		indexQueries.add(IndexBuilder.buildIndex(SampleEntity.builder().id("3").message("ac").build()));
